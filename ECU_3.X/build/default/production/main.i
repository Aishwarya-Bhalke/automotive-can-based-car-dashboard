...
void main(void) {
    ...
    clcd_print("RPM:", (0xC0 + (0)));
    clcd_print("SPEED:", (0x80 + (0)));
    clcd_print("GEAR:", (0x80 + (10)));
    clcd_print("IND:", (0xC0 + (8)));
    ...
    while(1)
    {
        ...
        if(msg_id == 0x00)
        {
            ...
            clcd_print(buff, (0xC0 + (4)));
        }
        else if(msg_id == 0x01)
        {
            button = data[0];
            clcd_print(str[button], (0xC0 + (12)));
        }
        else if(msg_id == 0x02)
        {
        ...
        else if(msg_id == 0x03)
        {
          ...
          clcd_putch((char)data[0], (0x80 + (15)));
        }

        if(button == 3 || prev_ind != button)
        {
            PORTB = 0x00;
        }
        ...
        if(delay++ == 200 && button == 0)
        {

            PORTB ^= 0x03;
        }
        else if(delay == 200 && button == 1)
        {

            PORTB ^= 0xC0;
        }
        else if(delay == 200 && button == 2)
        {
